...
import { CloseIcon, ArrowIcon, EnvelopeIcon, ExternalLinkIcon, BugIcon } from './icons';
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            >
              <div className="panel-header-game p-5 flex justify-between items-center bg-slate-700 text-white">
              ...
              <div className="flex-1 overflow-auto">
                ...
                <div className="p-4 space-y-3">
                  ...
                  >
                    <EnvelopeIcon size={16} className="text-slate-400" />
                    Contact Support
                  </a>
                ...
                <div className="p-4">
                  <button
                    ...
                    className="flex items-center gap-2 w-full py-2.5 px-3 rounded-xl bg-slate-50 border-2 border-slate-200 text-sm font-bold text-slate-700 hover:bg-slate-100 transition-colors"
                  >
                    <BugIcon size={16} className="text-slate-400" />
                    Debug Tools
                  </button>
                </div>
                ...
                <div className="p-4">
                  {!confirmReset ? (
                    ...
                    >
                      <ArrowIcon direction="refresh" size={15} />
                      Reset All Progress
                    </button>
                  ) : (
