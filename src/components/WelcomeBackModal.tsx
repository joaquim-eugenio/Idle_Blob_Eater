...
import { ClockIcon, CoinsStackIcon, CloseIcon, HandWaveIcon, TVIcon } from './icons';
  ...
  return (
    <div className="absolute inset-0 bg-black/50 z-50 flex items-center justify-center p-3 sm:p-6">
      ...
      >
        ...
        <div className="text-amber-400 flex justify-center mb-2"><HandWaveIcon size={48} /></div>
        ...
        <div className="space-y-2">
          ...
          >
            <TVIcon size={16} /> Watch Ad for 2x
          </button>
        </div>
      </motion.div>
    </div>
